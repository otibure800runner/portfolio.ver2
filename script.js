$(function(){
  ...
  $(".fullcolor,.hide-img").click(function(){
    //クリックしたhide-imgに対応したサムネを元に戻す
    var src = $(".mini-img1").attr("src").slice(0,-5);
    $(".mini-img1").attr("src",src + "1.png");
    $(".hide-img").hide();
    $(".fullcolor").hide();
  });
  //キャラ拡大表示：ガブ
  $(".mini-img2").click(function(){
    //ページ遷移一旦中止
    event.preventDefault();
    //クリックした画像の取得
    var src = $(this).attr("src").slice(0,-5);
  ...
  $(".fullcolor,.hide-img").click(function(){
    //クリックしたhide-imgに対応したサムネを元に戻す
    var src = $(".mini-img2").attr("src").slice(0,-5);
    $(".mini-img2").attr("src",src + "1.png");
    $(".hide-img").hide();
    $(".fullcolor").hide();
  });
